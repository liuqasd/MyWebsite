...
$comparison_datas = bigmart_comparison_datas();
...
if (!empty($comparison_datas)) {
    ...
    <div class="ms-comparison">
        <div class="cmp-head">
            <div class="row">
                <div class="cell"><?php _e('SNO', 'bigmart'); ?></div>
                <div class="cell"><?php _e('Theme Features', 'bigmart'); ?></div>
                <div class="cell free"><?php _e('Free', 'bigmart'); ?></div>
                <div class="cell pro"><?php _e('Pro', 'bigmart'); ?></div>
            </div>
        </div>
        <div class="cmp-body">
            <?php
